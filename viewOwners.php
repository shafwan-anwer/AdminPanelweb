...
<body>
    ...
    function AddItemToTable(fullName, email, mobileNo, vehicle, registeredDate) {
    ...
    function AddAllItemsToTable(users) {
        ...
        users.forEach(element => {
            AddItemToTable(element.fullName, element.email, element.mobileNo, element.vehicle, element
                .registeredDate);
        });
    }
    ...
    async function GetAllDataRealtime() {
        ...
        const q = query(collection(db, "users"), where("role", "==", "Vehicle owner"));
