...
<body>
    ...
    function AddItemToTable(fullName, email, mobileNo, registeredDate) {
    ...
    function AddAllItemsToTable(users) {
        ...
        users.forEach(element => {
            AddItemToTable(element.fullName, element.email, element.mobileNo, element.registeredDate);
        });
    }
